class MemberRepresenter < ApplicationRepresenter
  ...
  property :national_id_photo, readable: false
  property :national_id_photo_url, exec_context: :decorator, writeable: false
  ...
  def national_id_photo_url
    decorated.national_id_photo.convert('-strip').thumb('1080x1080').url if decorated.national_id_photo_stored?
  end
end
