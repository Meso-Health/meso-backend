...
Rollbar.configure do |config|
  ...
  config.scrub_fields |= [:password_digest, :secret_digest]
  ...
  config.code_version = UhpBackend.release.git_sha

  # Quiet down Rollbar's internal logging to write less to our logs
